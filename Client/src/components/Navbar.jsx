    ...
    <div className='fixed w-full z-10'>
        ...
        <div className='relative flex'> 
            ...
            <div className='my-auto'>
                <button onClick={changeMenu} className='border-0 rounded-full ' href=""><svg className='h-10 w-10 transition duration-200 hover:scale-105' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
            ...
            {menu &&(
                <div className='absolute top-16 right-5 p-5 border-0 rounded-lg bg-black'>
                    ...
                    <div className='capitalize flex flex-col py-2'>
                        <Link className='mx-2 my-1 hover:text-gray-300'>Profile</Link>
                        <Link className='mx-2 my-1 hover:text-gray-300'>settings </Link>
                        <Link className='mx-2 my-1 hover:text-gray-300'>LogIn</Link>
                    </div>
